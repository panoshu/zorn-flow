...
public class UlidIn extends AbstractRoutine<Object> {
     ...
     */
    public UlidIn() {
        super("ulid_in", Engine.ENGINE, DSL.comment(""), DefaultDataType.getDefaultDataType("\"engine\".\"ulid\""));
     ...
     */
    public UlidIn setInput(Field<Object> field) {
