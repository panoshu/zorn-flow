 ...
 * 数据库流程链仓库单元测试
 */
class DatabaseProcessChainRepositoryTest {

    @Mock
    private ReadWriteConfigSource readWriteConfigSource;

    private DatabaseProcessChainRepository databaseProcessChainRepository;

    @BeforeEach
    void setUp() {
        MockitoAnnotations.openMocks(this);
        databaseProcessChainRepository = new DatabaseProcessChainRepository(readWriteConfigSource);
    }
    ...
    void testFindById() {
        ...
        Optional<ProcessChain> result = databaseProcessChainRepository.findById(ProcessChainId.of("test-process-chain"));
    ...
    void testFindByIdNotFound() {
        ...
        Optional<ProcessChain> result = databaseProcessChainRepository.findById(ProcessChainId.of("non-existent"));
    ...
    void testFindByIdWithNullId() {
        Optional<ProcessChain> result = databaseProcessChainRepository.findById(null);
    ...
    void testFindAll() {
        ...
        Collection<ProcessChain> result = databaseProcessChainRepository.findAll();
    ...
    void testSave() {
        ...
        assertDoesNotThrow(() -> {
            databaseProcessChainRepository.save(processChain);
        });
    ...
    void testSaveAll() {
        ...
        assertDoesNotThrow(() -> {
            databaseProcessChainRepository.saveAll(processChains);
        });
    ...
    void testDelete() {
        ...
        assertDoesNotThrow(() -> {
            databaseProcessChainRepository.delete(processChain);
        });
    ...
    void testDeleteById() {
        ...
        assertDoesNotThrow(() -> {
            databaseProcessChainRepository.deleteById(processChainId);
        });
    ...
    void testRefresh() {
        ...
        boolean result = databaseProcessChainRepository.refresh();
    ...
    void testClearCache() {
        assertDoesNotThrow(() -> {
            databaseProcessChainRepository.clearCache();
        });
    ...
    void testClearCacheWhenException() {
        ...
        assertDoesNotThrow(() -> databaseProcessChainRepository.clearCache());
    }
    ...
    void testIsAvailable() {
        ...
        boolean result = databaseProcessChainRepository.isAvailable();
