...
public record ProcessNodeName(String value) implements DomainPrimitive, Identifier {
  ...
  public static ProcessNodeName of(String value) {
    return new ProcessNodeName(value);
  }

  public static ProcessNodeName of(ProcessNodeId processNodeId) {
    return new ProcessNodeName(processNodeId.value());
  }
}
