...
@Component
@ConditionalOnProperty(name = "gateway.security.replay.strategy", havingValue = "redis")
public class RedisReplayCache implements ReplayCache {

  private final String nonceKeyPrefix;
  private final ReactiveRedisTemplate<String, String> reactiveRedisTemplate;

  public RedisReplayCache(GatewaySecurityProperties props, ReactiveRedisTemplate<String, String> reactiveRedisTemplate) {
    this.reactiveRedisTemplate = reactiveRedisTemplate;
    this.nonceKeyPrefix = props.getReplayProperties().nonceKeyPrefix();
  }
